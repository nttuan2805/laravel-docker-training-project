...
class CreateMstModelV2TestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('mst_model_v2', function (Blueprint $table) {
        ...
        Schema::connection('mysql2')->table('mst_model_v2', function (Blueprint $table) {
